...
const sidebarItems = [
  { key: "", icon: LayoutDashboard, label: "pme.sidebar.dashboard" },
  { key: "new-analysis", icon: FolderPlus, label: "pme.sidebar.newAnalysis" },
...
export function PmeSidebar({ onLogout }: PmeSidebarProps) {
  const { t } = useLanguage();
