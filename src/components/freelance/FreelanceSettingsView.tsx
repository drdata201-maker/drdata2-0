...
interface FreelanceSettingsViewProps {
  userName: string;
  userEmail: string;
  userCountry: string;
...
export function FreelanceSettingsView({ userName, userEmail, userCountry, freelanceDomain, onLogout }: FreelanceSettingsViewProps) {
  const { t } = useLanguage();
      ...
      <section>
        ...
        <div className="rounded-xl border border-border bg-card p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div>
              <Label className="text-muted-foreground">{t("settings.profile.freelanceDomain")}</Label>
              <Input defaultValue={freelanceDomain} className="mt-1" />
            </div>
          </div>
